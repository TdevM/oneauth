...
let createAndSendOTP = function (mobile_number, otp, otp_purpose, otpHash) {
    return new Promise(function (resolve, reject) {
        let options = {
            ...
            qs: {
                ...
                sender: 'CDGBLK',
                text: `${otp} is the OTP for ${otp_purpose} valid for 10 mins. Please Do not share it with anyone.  ${otpHash}`,
